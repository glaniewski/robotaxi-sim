"""Profile demand_score policy at scale=0.05 to find walltime hotspots."""
...
policy = build_policy(
    name="demand_score", alpha=0.6, half_life_minutes=45, forecast_horizon_minutes=30,
    ...
    covered_by=covered_by, max_wait_time_seconds=MAX_WAIT, min_coverage=1,
)
import time
from tqdm import tqdm

total_reqs = len(requests)
bar = tqdm(total=total_reqs, desc="demand_score scale=0.05", unit="trips", ncols=90)
last_resolved = [0]
